...
@Component({
  selector: 'app-export-report-excel',
  templateUrl: './export-report-excel.component.html',
  styleUrls: ['./export-report-excel.component.scss']
})
export class ExportReportExcelComponent implements OnInit {
